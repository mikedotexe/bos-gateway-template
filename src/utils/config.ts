...
export const walletConnectProjectId: string = (process.env.NEXT_PUBLIC_WALLET_CONNECT_PROJECT_ID as string);
export const publicHostname: string = (process.env.NEXT_PUBLIC_HOSTNAME as string);
export const widget: string = (process.env.NEXT_PUBLIC_WIDGET as string);
